	...
	elseif($portfolio_layout == 'Half Thumbnails Without Spaces'){
		...
		$result['new_posts'] .='<div class="st_sf_strange_portfolio_item st_sf_port_style_ii '.$col.' '.$slugg.'">';
            $result['new_posts'] .='<div class="st_sf_vc_potrfolio" style="background:url('.$large_image_url[0].')">';
            	$result['new_posts'] .='<a class="single_img_link" target="_blank" href="'.get_the_permalink($post->ID).'">';
                $result['new_posts'] .='<div class="single_img st_sf_vc_port_mask"  style="background:'.get_post_meta($post->ID, 'port-bg', true).'">';
		...
		$result['new_posts'] .='<div class="textmid" id="text"><a href="http://www.facebook.com/sharer.php?u='.$large_image_url[0].'"><span class="icon-facebook"></span></a><a href="http://twitter.com/share?url='.$large_image_url[0].'"><span class="icon-twitter"></span></a><a href="http://pinterest.com/pin/create/button/?url='.$large_image_url[0].'"><span class="icon-pinterest"></span></a><a href="mailto:?Subject=Simple Share Buttons&amp;Body='.$large_image_url[0].'"><span class="icon-envelope"></span></a></div>';
					...
					$result['new_posts'] .='</div>';
				$result['new_posts'] .= '<div id="icons"><a href="'.$large_image_url[0].'" download><span class="icon-download"></span></a><span class="icon-share"></span></div>';
