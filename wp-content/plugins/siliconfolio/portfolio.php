...
<?php if ((get_post_meta($post->ID, 'st_sf_ps', 1)!='creative') && get_post_meta($post->ID, 'st_sf_ps', 1)!='modern') {?>
	...
	<div><img style="width: 100%;" src="<?php echo get_the_post_thumbnail_url( 6, 'full' ); ?>"></div>
...
<div class="st_sf_page_holder st_sf_without_sidebar">
    ...
    <div class="st_sf_port_filter_holder">
        ...
        <div class="st_sf_port_filter" id="filters"> 
            ...
            <div class="col-sm-12"><ul class="st_sf_list_cats">
                ...
                echo "<li class='cat-item'><a href='#' data-filter='*' class='filter_button'>All</a></li>";
...
<script type="text/javascript">
 ...
 $(".loader").css({"position": "fixed", "top": "50%"});
